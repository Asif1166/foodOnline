...
from menu.forms import Category_form, Food_form
...
#every time we use vendor from get_vendor
...
def v_profile(request):
    #get object in form field from database
    ...
    if request.method =='POST':
        ...
        if profile_form.is_valid() and vendor_form.is_valid():
            ...
            messages.error(request, 'somerthing went wrong')
...
def add_food(request):
    if request.method =='POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Food Item with this Food name already exists.')
    else:
        form = Food_form()
        #modify this form
